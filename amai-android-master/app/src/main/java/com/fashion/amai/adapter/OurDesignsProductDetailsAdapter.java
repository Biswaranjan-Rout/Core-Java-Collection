...
public class OurDesignsProductDetailsAdapter extends RecyclerView.Adapter<OurDesignsProductDetailsAdapter.ViewHolder> {

    private ArrayList<Dessert> items;

    public OurDesignsProductDetailsAdapter(){
        items = new ArrayList<>();
    ...
    public OurDesignsProductDetailsAdapter(ArrayList<Dessert> items){
        this.items = items;
    }
