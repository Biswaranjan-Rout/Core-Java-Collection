...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ViewHolder> {
    ...
    public void addAll(List<MerchantProductsByMerchantID.Datum> moveResults, MerchantInterface.Merchant productApiInterface, AppCompatActivity appCompatActivity) {
        ...
        this.merchantApiInterface = productApiInterface;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if ((dataSet.size() % 2) == 0) {
           if ((dataSet.size()-1) == position){
            holder.empty_view_below_products.setVisibility(View.VISIBLE);

        } else {
               holder.empty_view_below_products.setVisibility(View.GONE);
        ...
        holder.select_design_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        View empty_view_below_products;
//        ImageView emptyView;

        public ViewHolder(View view) {
            super(view);

            empty_view_below_products = itemView.findViewById(R.id.empty_view_below_products);
